...
public class LinkListerTests {
    ...
    @Test
    public void getLinksV2_ShouldHandleNonPrivateIP() throws Exception {
        // Arrange
        String testUrl = "http://8.8.8.8";
        List<String> expectedLinks = List.of("http://8.8.8.8/page1", "http://8.8.8.8/page2");
        Document mockDocument = mockJsoupDocument(expectedLinks);
